...
export function useSessionManager({ activeSession, setActiveSession, subscribeWithRetry, sendInput, wsConnected, onRawOutputUpdate, }) {
    ...
    const handleSendInput = useCallback(async (data) => {
    ...
    const handleKillSession = useCallback(async () => {
        ...
        if (!confirm(`Are you sure you want to kill session "${activeSession.description ?? activeSession.title}"?`)) {
            return;
        }
        try {
...
//# sourceMappingURL=use-session-manager.js.map