 ...
 */
export const ptyListSchema = z.object({});
 ...
 */
export const ptyListDescription = `Lists all PTY sessions (active and exited).
 ...
 */
export async function executePTYList(args?: PTYListArgs): Promise<string> {
